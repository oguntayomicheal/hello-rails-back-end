...
- git clone https://github.com/oguntayomicheal/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/oguntayomicheal/hello-rails-back-end/issues).
